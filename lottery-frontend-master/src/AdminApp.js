...
export default function AdminApp() {
  ...
  const [vipResultRange, setVipResultRange] = useState({ from: '2026-06-01', to: new Date().toISOString().slice(0, 10), window: '3', numberSize: '2', source: 'all' });
